---
title: "Pizza Party"
author: "Jinghan Zhou, Xi Feng, Charles Zhang, Roan Floer-Martinez "
output: 
  html_document:
    keep_md: yes
---
...
leaflet(data=pizza_datafiniti) %>% 
  ...
  addCircleMarkers(lngs = ~longitude, lat = ~latitude, color = "red", label=~name,stroke = FALSE, fillOpacity = 0.5, radius = 2)
```

### As this dataset shows that New York city has the most pizza 
